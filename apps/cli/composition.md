...
flowchart LR
  ...
  plugin_dsh_base_winuxsh_sandbox["winuxsh-sandbox<br/>@deepseek-ai/dsh-winuxsh-sandbox"]
  cfg --> plugin_dsh_base_winuxsh_sandbox
...
| `winuxsh-sandbox` | `@deepseek-ai/dsh-winuxsh-sandbox` |
