...
Source: [`packages/shell/winuxsh-local/src/index.ts:31`](../packages/shell/winuxsh-local/src/index.ts)
...
Depends on: [`LocalConfig`](#deepseek-aidsh-winuxsh-local)

Source: [`packages/shell/winuxsh-sandbox/src/index.ts:41`](../packages/shell/winuxsh-sandbox/src/index.ts)
