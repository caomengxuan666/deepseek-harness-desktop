...
<a id="deepseek-aidsh-winuxsh-local"></a>
...
来源：[`packages/shell/winuxsh-local/src/index.ts:31`](../packages/shell/winuxsh-local/src/index.ts)

<a id="deepseek-aidsh-winuxsh-sandbox"></a>
...
依赖：[`LocalConfig`](#deepseek-aidsh-winuxsh-local)

来源：[`packages/shell/winuxsh-sandbox/src/index.ts:41`](../packages/shell/winuxsh-sandbox/src/index.ts)
