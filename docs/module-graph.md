...
flowchart TD
  ...
  subgraph group_shell["packages/shell"]
    ...
    pkg_winuxsh_local["winuxsh-local"]
    pkg_winuxsh_sandbox["winuxsh-sandbox"]
  end
  ...
  pkg_winuxsh_local --> pkg_invariants
  pkg_winuxsh_local --> pkg_pwsh_local
  pkg_winuxsh_local --> pkg_settings
  pkg_winuxsh_local --> pkg_shell
  pkg_winuxsh_local --> pkg_subprocess
  pkg_winuxsh_local --> pkg_timeout
  ...
  pkg_winuxsh_sandbox --> pkg_invariants
  pkg_winuxsh_sandbox --> pkg_sandbox
  pkg_winuxsh_sandbox --> pkg_sandbox_policy
  pkg_winuxsh_sandbox --> pkg_shell
  pkg_winuxsh_sandbox --> pkg_winuxsh_local
...
| [`winuxsh-local`](../packages/shell/winuxsh-local) | `shell` | [`invariants`](../packages/runtime-diagnostics/invariants), [`pwsh-local`](../packages/shell/pwsh-local), [`settings`](../packages/settings/settings), [`shell`](../packages/shell/shell), [`subprocess`](../packages/subprocess/subprocess), [`timeout`](../packages/util/timeout) |
...
| [`winuxsh-sandbox`](../packages/shell/winuxsh-sandbox) | `shell` | [`invariants`](../packages/runtime-diagnostics/invariants), [`sandbox`](../packages/sandbox/sandbox), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`shell`](../packages/shell/shell), [`winuxsh-local`](../packages/shell/winuxsh-local) |
